...
//^^This is another tricky paragraph. Line 32 might need changing.
...
must not be tolerated, but haled to prison.
...
did not walk accordingly in their conduct, but were careless and loose,
...
//Is the "of which hereafter" above okay? It was marked in the book.
...
and took them by an order to prison.
