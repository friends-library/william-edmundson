...
many people came to the meeting and also went with the corps to the grave-yard.
...
accompanied by John Pim and Joshua Beale, to the bu.rial of Samuel Strangman,
...
Some time after the meeting was over, I returned home, from which,
...
and visited thereabout, and from there to a meeting at Edenderry, then to Isaac Fuller`'s,
and so to John Clibborn`'s,
